 ...
 */
package pboif2.pkg10119080.latihan40.warnakepribadian;
 ...
 * (OBJECT ORIENTED) Warna Kepribadian
 */
class WarnaKepribadian {
    ...
    public void cekKepribadian() {
        ...
        switch (warna) {
            case ("MERAH"):
                System.out.println("Warna Favoritmu adalah " + merah + warna + 
                                   normal);
            ...
            case ("KUNING"):
                ...
                System.out.println("6. Tidak suka meremehkan kekurangan "
                                   + "orang lain,");
